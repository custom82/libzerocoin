...
public:
    ...
    bool IsRFC6666() const; // IPv6 discard prefix (100::/64)
    bool IsTor() const;
    bool IsI2P() const;
    bool IsCJDNS() const;
    bool IsLocal() const;
    ...
    bool IsBogon() const; // Check if address is in bogon list
...
public:
    ...
    void Serialize(Stream& s) const {
        ...
        s.write((char*)&portN, sizeof(portN));
    }
    ...
    void Unserialize(Stream& s) {
        ...
        uint16_t portN;
        s.read((char*)&portN, sizeof(portN));
        port = ntohs(portN);
    }
...
bool IsSelectableSocket(SOCKET hSocket);
